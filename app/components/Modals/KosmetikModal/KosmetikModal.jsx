...
function KosmetikModal({ isOpen, handleClose }) {
  const t = useTranslations("modals");
  const items = t.raw("kosmetik.items");
  ...
  return (
    <>
      <Modal
        ...
        aria-labelledby="kosmetik-modal-title"
      >
        <Modal.Header closeButton>
          <Modal.Title
            id="kosmetik-modal-title"
